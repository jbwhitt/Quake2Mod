...
void soldier_dead (edict_t *self)
{
	...
	//ED_CallSpawn(FindItem("Adrenaline"));
...
// check for gib
	if (self->health <= self->gib_health)
	{
		...
		if (level.killed_monsters == 5){
			SP_item_Fireball(self);
		}
		else if (level.killed_monsters == 10){
			SP_item_BerserkBall(self);
		}
		else if (level.killed_monsters == 15){
			SP_item_InvulBall(self);
		}
		else{
			int luck;
			luck = crandom() * -10;
			...
			case 1:
				...
				break; 
			case 2:
				SP_item_GenadeLauncher(self);
				break;
			case 3:
				SP_item_Armor(self);
				break;
			case 4:
				SP_item_RocketLauncer(self);
				break;
			case 5:
				SP_item_Railgun(self);
				break;
			case 6:
				SP_item_Hyper(self);
				break;
			case 7:
				SP_item_Shotgun(self);
				break;
			case 8:
				SP_item_Machinegun(self);
				break;
			case 9:
				SP_item_Bullets(self);
				break;
			case 10:
				SP_item_Grenades(self);
				break;
			case 11:
				SP_item_Shells(self);
				break;
